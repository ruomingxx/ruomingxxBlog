...
import com.ruomingxx.blog.support.web.ViewHelper;
...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public String getApplicationEnv(){
        return this.env.acceptsProfiles(Constants.ENV_PRODUCTION) ? Constants.ENV_PRODUCTION : Constants.ENV_DEVELOPMENT;
    }
}
